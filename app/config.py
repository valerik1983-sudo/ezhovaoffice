...
MANAGER_IDS = [394410397, 5365576828]

# === T‑Банк (хардкод реальных ключей) ===
TBANK_TERMINAL_KEY = "1784399302912"
TBANK_SECRET_KEY = "VI*qqqr$51NCy$DT"
...
# === Webhook URLs ===
BASE_URL = os.getenv("BASE_URL", "https://ezhovaoffice.bothost.tech")
